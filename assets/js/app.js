const callInfo = () => {
    alert('The target of the Captcha is to get the correct number placement as it was generated by the system, any number marked with yellow is not properperly placed and the onces marked with red is invalid which means not generated in memory for the current session');
}
